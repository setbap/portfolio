    ...
    return (
        <motion.div initial={{ opacity: 0, scale: 0.6 }} animate={{ opacity: 1, scale: [1.2, 1] }} className="w-4/5 mx-auto text-white pt-8">
            <form action="mailto:ebr.sina@outlook.com?subject=contact with you" method="post" encType="text/plain" className="flex flex-col">
                <h2 className="text-center text-xl font-bold capitalize">Contact with me</h2>
                <h2 className="w-full flex flex-row text-3xl justify-center items-center p-8 ">
                    <a
                        className="hover:border-white border-b-2 border-transparent pb-1"
                        target="_blank"
                    ...
                    <div className="p-4" />
                    <a
                        className="hover:border-blue-500 border-b-2 border-transparent pb-1"
                        target="_blank"
                        rel="noopener noreferrer"
                        href="https://www.linkedin.com/in/sina-ebrahimi-88893314b/"
                    >
